...
class JogadorController {
    ...
    async list(req: Request, res: Response){ //lista
    ...
    async store(req: Request, res: Response){ //registra
        ...
        if(nicknameExists){ //se já existe o nome ele não retorna
    ...
    async delete(req: Request, res: Response){ //deleta
